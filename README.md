# 🍕 JWT Pizza
[![CI Pipeline](https://github.com/fernandomesser/jwt-pizza/actions/workflows/ci.yml/badge.svg)](https://github.com/fernandomesser/jwt-pizza/actions/workflows/ci.yml)
